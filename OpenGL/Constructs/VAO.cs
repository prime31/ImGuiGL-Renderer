...
namespace OpenGL
{
	public class VAO<T1> : GenericVAO where T1 : struct
	{
	...
	{
		[Obsolete("This VAO constructor is deprecated in favour of using VAO(ShaderProgram program, IGenericVBO[] vbos).")]
		public VAO(ShaderProgram program, VBO<T1> vbo1, string attribName, VBO<T2> elementArray) : base(program, false)
		{
			IGenericVBO[] vbos = new IGenericVBO[2];
			vbos[0] = new GenericVBO<T1>(vbo1, attribName);
		...
		[Obsolete("This VAO constructor is deprecated in favour of using VAO(ShaderProgram program, IGenericVBO[] vbos).")]
		public VAO(ShaderProgram program, VBO<T1> vbo1, string[] attribNames, VBO<T2> elementArray) : base(program, false)
		{
		...
		[Obsolete("This VAO constructor is deprecated in favour of using VAO(ShaderProgram program, IGenericVBO[] vbos).")]
		public VAO(ShaderProgram program, VBO<T1> vbo1, VBO<T2> vbo2, string[] attribNames, VBO<uint> elementArray)
			: base(program)
		{
			...
			vbos[2] = new GenericVBO<uint>(elementArray);
	...
	public class GenericVAO : IDisposable
	{
		...
		public struct GenericVBO<T> : IGenericVBO where T : struct
		{
...
#pragma warning restore
	...
	public class VAO : GenericVAO, IDisposable
	{
		...
		public VAO(ShaderProgram program, IGenericVBO[] vbos) : base(program, false)
		{
			Init(vbos);
		}
